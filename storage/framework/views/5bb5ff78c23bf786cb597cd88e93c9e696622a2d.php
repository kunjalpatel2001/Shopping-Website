   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 text-center mt-4">
            <?php if(isset($s->slug) && $s->slug != ""): ?>
            <a href="<?php echo e(route('shop')); ?>" class="view title-section view-all btn btn-primary "><?php echo e(__('msg.view_all')); ?></a>
            <?php endif; ?>
         </div>
      </div>
   </div>
</div><?php /**PATH /home2/dtljbjve/public_html/retailindiaweb/resources/views/themes/eCart_02/parts/style_2.blade.php ENDPATH**/ ?>