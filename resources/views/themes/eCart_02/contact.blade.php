      ...
      <div class="container-fluid">
         ...
         <div class="row inner-iconsec">
            <div class="col-md-3 pb-3 ">
               ...
               <p class="text-center text-capitalize"><strong>{{ __('msg.phone') }}:</strong> {{ Cache::get('whatsapp_number') }}</p>
            </div>
            <div class="col-md-3 pb-3 ">
               ...
               <p class="text-center text-capitalize"><strong>{{ __('msg.Address') }}:</strong>  {{ Cache::get('store_address') }}
               </p>
            </div>
            <div class="col-md-3 pb-3 ">
